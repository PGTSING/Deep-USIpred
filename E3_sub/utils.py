...
def returnID():
    f_2 = open(os.path.join("data/id_DUB_HUMAN.txt"), "r")
    f_3 = open(os.path.join("data/id_DUB_sub_HUMAN.txt"), "r")
    f_1 = open(os.path.join("new_data/id_E3.txt"), "r")
    f_4 = open(os.path.join("new_data/id_substrate.txt"), "r")
    # f_1 = open(os.path.join("data2/id_E3_remove_1.txt"), "r")
    # f_4 = open(os.path.join("data2/id_sub_remove_1.txt"), "r")
    id_DUB = {}
    id_DUB_sub = {}
    id_sub = {}
    id_e3 = {}
    ...
    return id_DUB,id_DUB_sub, id_sub, id_e3


def sample( random_seed):
    f_4 = open(os.path.join("new_data/id_E3_sub.txt"), "r")
    id_DUB ,id_DUB_sub,id_sub, id_e3 = returnID()
...
def emb():
    id_DUB ,id_DUB_sub, id_sub, id_e3 = returnID()
    file1 = open("../../data_extract/E3_seqVec_features_01.txt")
    E3 = {}
    ...
    file3 = open("../../data_extract/DUB_seqVec_features_HUMAN_01.txt")
    DUB = {}
    for line in file3:
        embed = line.strip().split(' ')
        DUB[embed[0]] = []
   ...
   #===================================================================
    DUB_sub = {}
    file123 = open("../../data_extract/DUB_sub_seqVec_features_HUMAN_01.txt")
    id = 0
    for line in file123:
        embed = line.strip().split(' ')
        DUB_sub[embed[0]] = []
    ...
    # print(len(DUB_emb_matirx))
    # print(DUB_emb_matirx)
    # print(len(DUB_sub_emb_matirx))
    # print(DUB_sub_emb_matirx)
   #===================================================================
    sub_embed_dict = {}
    file12 = open("../../data_extract/E3_sub_seqVec_features_01.txt")
